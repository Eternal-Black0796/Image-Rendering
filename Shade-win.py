...
def process_images(input_folder, output_folder):
    ...
    for image_file in tqdm(image_files, desc="Processing images", unit="image"):
        ...
        output_path = os.path.join(output_folder, os.path.splitext(image_file)[0] + '.png')  # 输出PNG格式
...
def initialize_gl(width, height):
    ...
    return vao, texture, shader_program
...
def main():
    ...
    vao, texture, shader_program = initialize_gl(width, height)
